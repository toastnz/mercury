<div class="breadCrumbs">
    <div class="breadCrumbs__wrap">
        <a href="{$BaseHref}" class="breadCrumbs__wrap__item breadCrumbs__wrap__item--icon" title="Home">
        ...
        <% if $Pages %>
        <% loop $Pages %>
        <div class="breadCrumbs__wrap__item breadCrumbs__wrap__item--divivder"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
        ...
        <% with $Top %>
            ...
            <div class="breadCrumbs__wrap__social">
                ...
                <a href="https://www.facebook.com/sharer.php?u=$AbsoluteLink" target="_blank" rel="noopener" class="breadCrumbs__wrap__social__link [ js-share-facebook ]" title="Share with Facebook">$SVG('facebook')</a>
                <a href="https://twitter.com/intent/tweet?text={$Title}&url=$AbsoluteLink" target="_blank" rel="noopener" class="breadCrumbs__wrap__social__link [ js-share-twitter ]" title="Share with Twitter">$SVG('twitter')</a>
            </div>
        <% end_with %>
    </div>
</div>