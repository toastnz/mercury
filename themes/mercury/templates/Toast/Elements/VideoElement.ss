...
<div class="element video-element video-element--{$Width} video-element--{$ID}">
    <div class="video-element__constraint">
        <div class="video-element__constraint__player" id="video-element--{$ID}"></div>
        <div class="video-element__constraint__thumbnail" onclick="playVideo('{$Video.VideoID}','video-element--{$ID}')" data-video-source="$Video.Service.LowerCase">
            <% if $Thumbnail %>
        ...
        <div class="video-element__constraint__icon">
