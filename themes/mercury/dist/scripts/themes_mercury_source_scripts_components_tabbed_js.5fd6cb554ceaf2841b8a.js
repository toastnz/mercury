...
var updateTabbedContent = function updateTabbedContent(indicator, currentTab) {
  ...
  if (currentTab) {
    ...
    [grandparent.querySelectorAll('.js-tabs-item', tabbedContent)].forEach(function (tabbedContentItem) {
...
//# sourceMappingURL=themes_mercury_source_scripts_components_tabbed_js.5fd6cb554ceaf2841b8a.js.map?id=[query]