...
var updateTabbedContent = function updateTabbedContent(indicator, currentTab) {
  ...
  if (currentTab) {
    ...
    _toConsumableArray(queryAll('.js-tabs-item', tabbedContent)).forEach(function (tabbedContentItem) {
      tabbedContentItem.style.display = 'none';
    });

    console.log(grandparent.querySelector(".js-tabs-item:nth-child(".concat(index, ")")));
...
//# sourceMappingURL=themes_mercury_source_scripts_components_tabbed_js.89802408e88af392bfff.js.map?id=[query]