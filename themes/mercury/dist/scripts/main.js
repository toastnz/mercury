...
jquery__WEBPACK_IMPORTED_MODULE_5___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('select.dropdown').each(function (index, select) {
    var choices = new choices_js__WEBPACK_IMPORTED_MODULE_6___default.a(select, {
