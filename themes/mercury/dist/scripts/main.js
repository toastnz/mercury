...
jquery__WEBPACK_IMPORTED_MODULE_8___default()(function () {
  new _components_shop__WEBPACK_IMPORTED_MODULE_7__["default"](jquery__WEBPACK_IMPORTED_MODULE_8___default()('body'));
});
/*------------------------------------------------------------------
Import external
------------------------------------------------------------------*/
...
var $body = jquery__WEBPACK_IMPORTED_MODULE_8___default()('body');
...
jquery__WEBPACK_IMPORTED_MODULE_8___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_8___default()('select.dropdown').each(function (index, select) {
    new choices_js__WEBPACK_IMPORTED_MODULE_9___default.a(select, {
  ...
  _createClass(Shop, [{
    ...
    value: function removeFromSideCart(e) {
      ...
      var params = {
        ...
        data: {
          quantity: 0,
          line: $this.attr('data-cart-item-index')
        },
        dataType: 'json'
      };
      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.getJSON(params, function () {
...
/*!***************************************************************!*\
  !*** ./themes/mercury/source/scripts/components/templates.js ***!
  \***************************************************************/
/*! exports provided: searchPlaceholder, searchItem, emptySideCart, sidecartItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var emptySideCart = function emptySideCart() {
  return "<h2>Nothing in your cart yet</h2>";
};
/**
* Return a template for a sidecart item
* @returns {string}
