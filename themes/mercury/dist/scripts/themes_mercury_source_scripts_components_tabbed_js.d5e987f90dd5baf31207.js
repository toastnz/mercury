...
var updateTabbedContent = function updateTabbedContent(indicator, currentTab) {
  ...
  if (currentTab) {
    ...
    console.log(parent.parentNode.querySelector(".js-tabs-item:nth-child(".concat(index, ")")));
...
//# sourceMappingURL=themes_mercury_source_scripts_components_tabbed_js.d5e987f90dd5baf31207.js.map?id=[query]